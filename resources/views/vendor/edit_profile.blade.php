                            ...
                            <div class="row">
                                <div class="col-xl-6 col-md-6">
                                    <div class="wsus__dash_pro_single">
                                        ...
                                        <input type="text" name="first_name" placeholder="First Name" value="{{ $vendor->name }}">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6">
                                    <div class="wsus__dash_pro_single">
                                        <i class="fas fa-user-tie"></i>
                                        <input type="text" name="last_name" placeholder="Last Name" value="{{ explode(' ', $vendor->user_name)[1] ?? '' }}">
                                    </div>
                                </div>
                                <div class="col-xl-6 col-md-6">
                                    <div class="wsus__dash_pro_single">
                                        <i class="far fa-phone-alt"></i>
                                        <input type="text" name="phone" placeholder="Phone" value="{{ old('phone', $vendor->phone ?? '') }}">
                                ...
                                <div class="col-xl-6 col-md-6">
                                    <div class="wsus__dash_pro_single">
                                        ...
                                        <input type="email" name="email" placeholder="Email" value="{{ $vendor->email }}">
                                    </div>
                                </div>
                            </div>
                        </div>
