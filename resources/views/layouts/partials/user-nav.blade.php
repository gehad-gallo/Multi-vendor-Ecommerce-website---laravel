              ...
              <div class="flex justify-between h-16">
                  <div class="flex">
                      ...
                      <div class="flex-shrink-0 flex items-center">
                          <a href="{{ route('user.dashboard') }}" class="text-xl font-bold text-white hover:text-yellow-400 transition">
                              User Panel
                          </a>
                      </div>
                      ...
                      <div class="hidden sm:-my-px sm:ml-10 sm:flex space-x-6 items-center">
                          <a href="{{ route('user.dashboard') }}" class="hover:text-yellow-400 transition">Dashboard</a>
